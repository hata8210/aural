 ...
 */
export const REPORT_MODEL = process.env.AI_REPORT_MODEL || (process.env.OPENAI_API_KEY
  ? "gpt-4o"
 ...
 */
export const GENERATOR_MODEL = process.env.AI_GENERATOR_MODEL || (process.env.OPENAI_API_KEY
  ? "gpt-4o-mini"
  : process.env.GEMINI_API_KEY
    ? "gemini-3.1-flash-lite"
    : process.env.KIMI_API_KEY
